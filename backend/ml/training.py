...
custom_transforms = []
#data="dataset.yaml"
results = model.train(data=str(pathlib.Path(__file__).parent / "dataset.yaml"), epochs= 15, imgsz=512, batch=16, cls=2.0,
                      degrees=15, perspective=0.0005, flipud=0.3, fliplr=0.5, hsv_v=0.4, hsv_s=0.3, hsv_h=0.01, mosaic=0.5,mixup=0.1, copy_paste=0.1, patience=20, name="model_v3_less_background")
