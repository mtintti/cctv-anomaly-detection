...
export default async function FrontPage(){
   ...
   const stationdata: StationsRes = await stationsAll.json();
    ...
    <div className="text-center">
        ...
        <p className="max-w-md mx-auto mt-2 text-gray-500"></p>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-9 mt-8">
        <div className="flex gap-4 items-start">
            ...
            <div>
                <h3 className="font-semibold text-xl">Detect</h3>
                <p className="mt-1 text-gray-500"> Analyze CCTV images using machine learning models trained to identify unusual visual patterns. The system helps highlight potentially abnormal situations that may require further inspection.</p>
            </div>
        </div>
        ...
        <div className="flex gap-4 items-start">
            ...
            <div>
                <h3 className="font-semibold text-xl">Camera Integration</h3>
                <p className="mt-1 text-gray-500">Browse and search 800 traffic-camera stations located in Finland through a unified interface. Select camera presets directly from available station feeds without manually locating image sources. </p>
            </div>
        </div>
        ...
        <div className="flex gap-4 items-start">
            ...
            <div>
                <h3 className="font-semibold text-xl">Image Upload</h3>
                <p className="mt-1 text-gray-500">Upload your own image for instant analysis. The platform supports user-provided snapshots alongside live traffic-camera imagery, enabling flexible comparison.</p>
            </div>
        </div>
        ...
        <div className="flex gap-4 items-start">
            ...
            <div>
                <h3 className="font-semibold text-xl">Fast Real-Time Processing</h3>
                <p className="mt-1 text-gray-500">A REST-based backend provides structured responses and integrates seamlessly with the frontend application.</p>
            </div>
        </div>
    </div>
</div>
